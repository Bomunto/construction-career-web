...
export const formations: Formation[] = [
  {
    ...
    description:
      "Devenez des professionnels en Gestion de Projet ! Cette filière forme des professionnels capables de planifier, coordonner et superviser des projets de construction.",
    duration: "03 Mois",
  ...
  },
  {
    ...
    title: "BIM Manager",
    description:
      "Devenez des professionnels en gestion BIM ! La filière forme des experts du Building Information Modeling (BIM), une méthode innovante de gestion de projets de construction.",
    duration: "03 Mois",
    niveau: "Avancé",
    emplois: [
      "BIM Manager",
    ...
    detailedDescription:
      "La filière forme des experts du Building Information Modeling (BIM), une méthode innovante de gestion de projets de construction basée sur des maquettes numériques 3D. Le BIM Manager coordonne les acteurs du chantier, optimise les coûts, les délais et la qualité grâce à des outils numériques avancés.",
    prerequisites: [
  ...
  },
  {
    ...
    description:
      "Devenez des professionnels en Design de Cuisine ! Cette formation prépare à la conception de cuisines modernes, fonctionnelles et esthétiques.",
    duration: "02 Mois",
    niveau: "Débutant",
    emplois: [
      "Designer de cuisine",
      "Concepteur d'intérieur",
      "Spécialiste aménagement",
      "Consultant cuisine",
    ],
    color: "from-pink-500 to-pink-600",
    detailedDescription:
      "Cette formation prépare à la conception de cuisines modernes, fonctionnelles et esthétiques. Elle combine design, ergonomie et techniques de modélisation pour former des professionnels prêts à intégrer des agences, des marques ou à travailler en freelance.",
    prerequisites: [
  ...
  },
  {
    ...
    description:
      "Devenez des professionnels en Conception Graphique et en Architecture d'Intérieur ! La filière forme des professionnels capables de concevoir, d'aménager et de valoriser des espaces intérieurs.",
    duration: "12 Mois",
    niveau: "Intermédiaire",
    emplois: [
  ...
  },
  {
    ...
    description:
      "Devenez des professionnels en Ingénierie BTP ! La filière forme des ingénieurs spécialisés dans la conception, la planification et la réalisation d'infrastructures.",
    duration: "02 Mois",
    niveau: "Avancé",
    emplois: [
      "Ingénieur BTP",
    ...
    detailedDescription:
      "La filière forme des ingénieurs spécialisés dans la conception, la planification et la réalisation d'infrastructures : bâtiments, routes, ponts, etc. Alliant rigueur technique et gestion de projet, l'ingénieur BTP est un acteur clé du développement durable et urbain.",
    prerequisites: [
